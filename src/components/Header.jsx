...
const Header = () => {
  return (
    <header className="flex items-center justify-between w-full py-0 px-[30px] h-20 fixed top-[0] z-10 bg-transparent mb-[-73px] bg-neutral-800 text-slate-100 opacity-85">
